"""Skill canonicalisation audit CLI.

Read all extracted required_skills from the database and report:
- 40 most common raw skill strings with their canonicalised forms
- Singletons (seen only once, likely typos or junk)
